...
export default function VisitBillingPage() {
  ...
  if (loading) {
    return <RoleGuard allowedRoles={['super_admin', 'hospital_admin', 'billing_staff', 'receptionist', 'nurse']}><div className="flex items-center justify-center h-96"><Loader2 className="h-8 w-8 animate-spin text-gray-400" /></div></RoleGuard>
  }

  if (error && !appointment) {
    return <RoleGuard allowedRoles={['super_admin', 'hospital_admin', 'billing_staff', 'receptionist', 'nurse']}><div className="p-8 text-center text-red-500">{error}</div></RoleGuard>
  }

  if (!appointment) {
    return <RoleGuard allowedRoles={['super_admin', 'hospital_admin', 'billing_staff', 'receptionist', 'nurse']}><div className="p-8 text-center">Appointment not found</div></RoleGuard>
  }
  ...
  return (
    <RoleGuard allowedRoles={['super_admin', 'hospital_admin', 'billing_staff', 'receptionist', 'nurse']}>
